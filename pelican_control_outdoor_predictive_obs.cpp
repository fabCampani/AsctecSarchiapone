...
Module0::DoYourDuty(int wc)
{
	...
	*/
	...
	if (true){		
		...
		if ((dxrDeb - dxrGPS) > thr_vel){
			dxrT = dxrDeb - thr_vel;
		}
		else if ((dxrDeb - dxrGPS) < -thr_vel){
			dxrT = dxrDeb + thr_vel;
		}
		else
			dxrT = dxrGPS;

		if ((dyrDeb - dyrGPS) > thr_vel){
			dyrT = dyrDeb - thr_vel;
		}
		else if ((dyrDeb - dyrGPS) < -thr_vel){
			dyrT = dyrDeb + thr_vel;
		}
		else
			dyrT = dyrGPS;
		if ((dzrDeb - dzrGPS) > thr_vel){
			dzrT = dzrDeb - thr_vel;
		}
		else if ((dzrDeb - dzrGPS) < -thr_vel){
			dzrT = dzrDeb + thr_vel;
		}
		else
			dzrT = dzrGPS;
